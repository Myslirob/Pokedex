...
export type PokemonsQuery = { __typename?: 'Query', pokemons: { __typename?: 'PokemonConnection', edges: Array<{ __typename?: 'Pokemon', name: string, id: string, types: Array<string>, isFavorite: boolean, image: string }> } };
